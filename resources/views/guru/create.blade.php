    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">TAMBAHKAN GURU</h3></div>
        ...
        $(document).ready(function () {
            ...
            $('#add').click(function () {
                ...
                $('#dynamic_field').append('<tr id="row' + i 
                        ...
                        + '"' + i 
                        + '"<td class="custom-tbl"><input id="guru' + i 
                        + '"class="form-control input-sm" style="width:100%;" type="text"' + i 
                        + ');" name="guru[]"></td><td class="custom-tbl"><input id="mapel"' + i 
                        + '"class="form-control input-sm" style="width:100%;" type="text" name="mapel[]"></td>' + i 
